...
class UgvDriver(Node):
    def __init__(self, name):
        super().__init__(name)
        self.get_logger().info("UGV Driver node initialized.")
        ...
        self.led_ctrl_sub = self.create_subscription(
            Float32MultiArray, "ugv/led_ctrl", self.led_ctrl_callback, 10
        )
    ...
    def joint_states_callback(self, msg):
        ...
        print("joint_states_callback", joint_data)
    ...
    def led_ctrl_callback(self, msg):
        ...
        print("led_ctrl_callback", led_ctrl_data)
...
def main(args=None):
    print("Starting UGV Driver main function.")
