...
class ugv_bringup(Node):
    def __init__(self):
        ...
        print("Initializing ugv_bringup node...")
        ...
        print("ugv_bringup node initialized.")

    # Main loop for reading sensor feedback and publishing it to ROS topics
    def feedback_loop(self):
        self.base_controller.feedback_data()
        if (
            self.base_controller.base_data["T"] == 1001
        ):  # Check if the feedback type is correct
...
def main(args=None):
    print("Starting ugv_bringup main function.")
